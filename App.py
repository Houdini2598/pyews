...
st.set_page_config(page_title='Pyews: A Summarised News Portal', page_icon='./Meta/newspaper.ico')
...
def run():
    st.title("Pyews: A Summarised News")
    image = Image.open('./Meta/newspaper.ico')
